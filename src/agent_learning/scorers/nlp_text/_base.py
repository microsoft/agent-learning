...
class _NlpTextScorerBase:
    ...
    # ----- training -----
    def fit(self, training_rows: Sequence[Dict[str, Any]]) -> "_NlpTextScorerBase":
...
__all__ = ["_NlpTextScorerBase", "_join_text", "_require_sklearn"]
