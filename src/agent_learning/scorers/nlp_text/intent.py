...
@dataclass
class NlpTextIntentScorer(_NlpTextScorerBase):
    ...
    def score(
        ...
        **_: object,
        ...
        if not query or not response:
            raise ValueError(
                "intent NLP text scorer requires both query and response"
            )
