...
Write-Host "=== azure-agents-learning-sdk publish ===" -ForegroundColor Cyan
...
try {
    ...
    switch ($Target) {
        ...
        'testpypi' {
            ...
            Write-Host "  https://test.pypi.org/project/azure-agents-learning-sdk/"
        }
        'pypi' {
            ...
            Write-Host "`nPublished. View at:" -ForegroundColor Green
            Write-Host "  https://pypi.org/project/azure-agents-learning-sdk/"
        }
    }
}
finally {
